...
public class AccCreation extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(990, 150, 992, 51);

        jLabel2.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setText("NIC/Passport");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(360, 120, 150, 30);
        ...
        jTextField1.setBounds(600, 110, 260, 50);

        jLabel3.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("First Name");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(360, 200, 110, 30);

        jTextField2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jPanel1.add(jTextField2);
        jTextField2.setBounds(600, 190, 260, 50);

        jLabel4.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(255, 255, 255));
        jLabel4.setText("Email");
        jPanel1.add(jLabel4);
        jLabel4.setBounds(360, 360, 110, 30);

        jTextField3.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jPanel1.add(jTextField3);
        jTextField3.setBounds(600, 270, 260, 50);

        jLabel5.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(255, 255, 255));
        jLabel5.setText("Contact Number");
        jPanel1.add(jLabel5);
        jLabel5.setBounds(360, 430, 170, 30);

        jTextField4.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jPanel1.add(jTextField4);
        jTextField4.setBounds(600, 350, 260, 50);

        jLabel6.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Password");
        jPanel1.add(jLabel6);
        jLabel6.setBounds(360, 510, 100, 30);
        ...
        jButton1.setBounds(360, 690, 120, 40);
        ...
        jButton2.setBounds(510, 690, 120, 40);
        ...
        jButton3.setBounds(670, 690, 120, 40);
        ...
        jButton4.setBounds(530, 790, 120, 40);

        jLabel7.setFont(new java.awt.Font("Segoe UI Black", 3, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(204, 204, 204));
        jLabel7.setText("Already Create Account?");
        jPanel1.add(jLabel7);
        jLabel7.setBounds(470, 750, 240, 30);

        jLabel8.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Confirm Password");
        jPanel1.add(jLabel8);
        jLabel8.setBounds(350, 590, 180, 40);
        ...
        jPasswordField1.setBounds(600, 510, 260, 50);
        ...
        jPasswordField2.setBounds(600, 590, 260, 50);

        jLabel9.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        jLabel9.setForeground(new java.awt.Color(255, 255, 255));
        jLabel9.setText("Last Name");
        jPanel1.add(jLabel9);
        jLabel9.setBounds(360, 290, 110, 30);

        jTextField5.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jPanel1.add(jTextField5);
        jTextField5.setBounds(600, 420, 260, 50);

        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/book-6314978.jpg"))); // NOI18N
        jLabel10.setText("jLabel10");
        jPanel1.add(jLabel10);
        jLabel10.setBounds(-130, 0, 2130, 1030);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
                ...
                int len1=ConfirmPassword.length();
                String pattern = "(?=.*[0-9])(?=.*[a-z])(?=.*[A-Z])(?=.*[@#$%^&+=])(?=\\S+$).{8,}";
                if(NIC.equals(""))
                {
                    JOptionPane.showMessageDialog(null,"Please enter the NIC","Error",JOptionPane.ERROR_MESSAGE);
                }
                ...
                {
                    JOptionPane.showMessageDialog(null,"Please follow the below rules"
                            ...
                            + "6. at least 8 characters","Error",JOptionPane.ERROR_MESSAGE);
                }
               ...
               else
                {
                    ...
                    String query="INSERT INTO acccreation (NIC,FirstName,LastName,Email,ContactNumber,Password,ConfirmPassword) values('" + NIC + "','" + FirstName + "','" + LastName + "','" + Email + "','" + ContactNumber + "','"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AccCreation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
